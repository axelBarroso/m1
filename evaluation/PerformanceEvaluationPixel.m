function [pixelPrecision, pixelAccuracy, pixelSpecificity, pixelSensitivity, F] = PerformanceEvaluationPixel(pixelTP, pixelFP, pixelFN, pixelTN)
    ...
    F = 2 * pixelPrecision * pixelSensitivity / (pixelPrecision + pixelSensitivity);
end
